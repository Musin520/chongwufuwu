...
-- 插入公司数据（使用正确的用户ID引用）
INSERT INTO company (companyname, companydescription, companyaddress, companyphone, companyemail, companylicense, companylegal, companyimg, userid) VALUES
('爱宠服务中心', '专业的宠物护理服务', '北京市朝阳区宠物街1号', '010-12345678', 'aichong@example.com', 'BJ001234567890', '王经理', '/images/company1.jpg', (SELECT id FROM sysuser WHERE account = 'maijia4')),
('宠物乐园', '提供全方位宠物服务', '北京市海淀区宠物大道2号', '010-87654321', 'chongwu@example.com', 'BJ009876543210', '李经理', '/images/company2.jpg', NULL);

-- 插入产品类型数据
INSERT INTO producttype (typename, typedescription) VALUES
('宠物美容', '专业的宠物美容护理服务'),
('宠物医疗', '宠物健康检查和医疗服务'),
('宠物寄养', '安全可靠的宠物寄养服务'),
('宠物训练', '专业的宠物行为训练'),
...
-- 插入产品数据（使用正确的外键引用）
INSERT INTO product (productname, productdescription, productprice, productimg, productdetailimg, companyid, typeid, service_start_time, service_end_time, rating) VALUES
('宠物洗澡美容', '专业宠物洗澡、修毛、美容服务', 88.00, '/images/product1.jpg', '/images/detail1.jpg,/images/detail2.jpg', (SELECT id FROM company WHERE companyname = '爱宠服务中心'), (SELECT id FROM producttype WHERE typename = '宠物美容'), '09:00:00', '18:00:00', 4.5),
('宠物健康检查', '全面的宠物健康体检服务', 150.00, '/images/product2.jpg', '/images/detail3.jpg,/images/detail4.jpg', (SELECT id FROM company WHERE companyname = '爱宠服务中心'), (SELECT id FROM producttype WHERE typename = '宠物医疗'), '08:00:00', '17:00:00', 4.8),
('宠物日托服务', '白天宠物托管照料服务', 120.00, '/images/product3.jpg', '/images/detail5.jpg', (SELECT id FROM company WHERE companyname = '宠物乐园'), (SELECT id FROM producttype WHERE typename = '宠物寄养'), '08:00:00', '19:00:00', 4.2),
('宠物基础训练', '宠物基本行为训练课程', 200.00, '/images/product4.jpg', '/images/detail6.jpg', (SELECT id FROM company WHERE companyname = '爱宠服务中心'), (SELECT id FROM producttype WHERE typename = '宠物训练'), '10:00:00', '16:00:00', 4.6);
